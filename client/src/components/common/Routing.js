...
export const Routing = () => {
  ...
  const mainPrimaryColor = prefersDarkMode === "dark" ? "#FFBD59" : "#FF914D";
  const mainSecondaryColor = prefersDarkMode === "dark" ? "#FF914D" : "#FFBD59";
      ...
      <ThemeProvider theme={theme}>
        <BrowserRouter>
          <Switch>
            ...
            <PrivateRoute exact path="/follows" component={Friends} />
